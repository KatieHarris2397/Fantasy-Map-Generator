# Nexlayer — fast-drift-fantasy-map-generator

**Live:** [https://kitbear-studio-fast-drift-fantasy-map-generator.cloud.nexlayer.ai](https://kitbear-studio-fast-drift-fantasy-map-generator.cloud.nexlayer.ai)  

**Runtime:** node · **Port:** 3000 · **Deploy branch:** master

---

## How this deployment works

**fast-drift-fantasy-map-generator** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
```yaml
application:
  name: fast-drift-fantasy-map-generator
  pods:
    - name: app
...
> `${podName:port}` syntax. CI/CD runs on push to `master`."*
